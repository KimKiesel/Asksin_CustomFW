...
registerCustomFW()
{
  #Register HM-LC-Sw1PBU-FM-CustomFW
  ...
  #Register HM-LC-Sw2PBU-FM-CustomFW
  {$HMConfig::culHmModel{"F0B0"} = {name=>"HM-LC-Sw2PBU-FM-CustomFW",st=>'remoteAndSwitch',cyc=>'',rxt=>'',lst=>'1,3:3p.4p,4:1p.2p',chn=>"Btn:1:2,Sw:3:4"}}
  {$HMConfig::culHmChanSets{"HM-LC-Sw2PBU-FM-CustomFW00"}{fwUpdate} ="<filename>"};
  {$HMConfig::culHmChanSets{"HM-LC-Sw2PBU-FM-CustomFW01"} = $HMConfig::culHmSubTypeSets{"THSensor"}};
  {$HMConfig::culHmChanSets{"HM-LC-Sw2PBU-FM-CustomFW02"} = $HMConfig::culHmSubTypeSets{"THSensor"}};
  {$HMConfig::culHmChanSets{"HM-LC-Sw2PBU-FM-CustomFW03"} = $HMConfig::culHmSubTypeSets{"switch"}};
  {$HMConfig::culHmChanSets{"HM-LC-Sw2PBU-FM-CustomFW04"} = $HMConfig::culHmSubTypeSets{"switch"}};
  {$HMConfig::culHmRegChan{"HM-LC-Sw2PBU-FM-CustomFW01"}  = $HMConfig::culHmRegType{remote}};
  {$HMConfig::culHmRegChan{"HM-LC-Sw2PBU-FM-CustomFW02"}  = $HMConfig::culHmRegType{remote}};
  {$HMConfig::culHmRegChan{"HM-LC-Sw2PBU-FM-CustomFW03"}  = $HMConfig::culHmRegType{switch}};
  {$HMConfig::culHmRegChan{"HM-LC-Sw2PBU-FM-CustomFW04"}  = $HMConfig::culHmRegType{switch}};

  #Log(1, "Registered F0A9");
}

#Log(1, "Loaded CustomFS");
InternalTimer(gettimeofday()+10,"registerCustomFW","nothing", 0);
...
#    push @evtEt,[$shash,1,"boot:"     .((hex($eCnt)&0x800000)?"on":"off");];
    ...
    Log(1, "Asksin_CustomFW received unknown message: $mFlg,$mTp,$src,$dst,$p");
  }
