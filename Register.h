//- Software config --------------------------------------------------------------------------------------------------------
//Define type of device (HM_LC_Sw1PBU_FM or HM_LC_Sw2PBU_FM)
//#define HM_LC_Sw1PBU_FM
#define HM_LC_Sw2PBU_FM

//If defined, the LED is turned on when the relay is on
#define LED_SHOW_RELAY_STATE

//Define serial output (for debugging or serial control)
//#define USE_SERIAL
...
const uint8_t  HMID[3]     = { 0x4D, 0x06, 0x7E };     // 208557
